...
import { CreditCard, CheckCircle2, Clock, XCircle, Download, TrendingUp, DollarSign, ArrowDownRight, User } from "lucide-react";
...
const mockPayments = [
    { id: "p-401", description: "Monthly Rent – Lease #L-001 (Unit 5B)", user: "Alice Uwimana", date: "2026-02-01", amount: 1800, method: "Bank Transfer", status: "PAID" as PaymentStatus, type: "LEASE" },
    { id: "p-402", description: "Booking – Unit 3A (Green Apartments)", user: "Marie Claire", date: "2026-01-20", amount: 840, method: "Credit Card", status: "PAID" as PaymentStatus, type: "BOOKING" },
    { id: "p-403", description: "Monthly Rent – Lease #L-002 (Room 3)", user: "Eric Mugabo", date: "2026-02-01", amount: 950, method: "Mobile Money", status: "PAID" as PaymentStatus, type: "LEASE" },
    { id: "p-404", description: "Security Deposit – Studio A", user: "David Iradukunda", date: "2026-01-05", amount: 3600, method: "Bank Transfer", status: "PAID" as PaymentStatus, type: "DEPOSIT" },
    { id: "p-405", description: "Booking – Villa Suite (Sunset Villas)", user: "Sarah Ingabire", date: "2026-03-10", amount: 1200, method: "Credit Card", status: "PENDING" as PaymentStatus, type: "BOOKING" },
    { id: "p-406", description: "Monthly Rent – Lease #L-001 (Unit 5B)", user: "Alice Uwimana", date: "2026-01-01", amount: 1800, method: "Bank Transfer", status: "PAID" as PaymentStatus, type: "LEASE" },
    { id: "p-407", description: "Booking – Room 12 (Garden View)", user: "Patrick Uwase", date: "2026-03-15", amount: 450, method: "Mobile Money", status: "PENDING" as PaymentStatus, type: "BOOKING" },
    { id: "p-408", description: "Monthly Rent – Lease #L-003 (Studio A)", user: "Marie Claire", date: "2026-02-01", amount: 1000, method: "Credit Card", status: "FAILED" as PaymentStatus, type: "LEASE" },
];
...
export default function AdminPaymentsPage() {
    ...
    return (
        <div>
            <AdminHeader title="All Payments" subtitle="System-wide payment tracking and revenue" />
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <span className="text-sm text-muted-foreground whitespace-nowrap flex items-center gap-1">
                                        <User className="h-3 w-3" /> {payment.user}
                                    </span>
