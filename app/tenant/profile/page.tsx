...
export default function ProfilePage() {
    ...
    const [form, setForm] = useState({
        ...
        phone: user?.phone ?? "+1 555 901 2345",
    });
            ...
            <div className="p-6 mx-auto space-y-6">
                ...
                >
                    ...
                    <div>
                        ...
                        <div className="flex items-center gap-2 mt-2">
                            <span className="text-[11px] font-medium px-2.5 py-1 rounded-full bg-accent/10 text-accent border border-accent/20">
                                TENANT
                            </span>
                ...
                {activeTab === "Notifications" && (
                    ...
                    >
                        ...
                        {[
                            { label: "Booking Confirmations", desc: "When your booking is confirmed", enabled: true },
                            { label: "Payment Reminders", desc: "Before rent is due", enabled: true },
                            { label: "Lease Updates", desc: "When lease documents are updated", enabled: true },
                            { label: "New Properties", desc: "Matching your saved search criteria", enabled: false },
                            { label: "Promotional Offers", desc: "Deals and special pricing", enabled: false },
                        ].map((item, i) => (
